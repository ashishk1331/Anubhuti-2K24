    ...
    category: [
      {
        ...
        description:
          "A typical form of the parliamentary debate with the simplifications of the rules so that every person can simply understand the event and enjoy it. The event will consist of a speaker, ruling side and an opposition.",
        language: "Bilingual",
        scopeOfEvent: "Major",
        Venue: "CSA",
      ...
      },
      {
        categoryName: "मंथन",
        description:
          "An event consists of two stages: Group Discussion and panel discussion. The event will take place in two stages. The first will be the introductory round, consisting of the group discussion. The top-performing candidates will move to the next round, which will be a panel discussion. ",
        language: "Hindi",
        scopeOfEvent: "Major",
    ...
    solo: [
      {
        ...
        description:
          "Participant recites his/her self-written poem purely in Hindi (no use of Urdu words).",
        rounds: [
          {
            noOfRounds: 2,
      ...
      },
      {
        ...
        description:
          "Participants recite his/her self-written poem purely in English.",
        rounds: [
          {
            noOfRounds: 2,
            round1: "Online entry (video entry)",
      ...
      },
      {
        ...
        description:
          "Two teams compete with each other in such a way the second team recites a sher starting with the last letter of sher recited by the first team. (First,sher will be given by the host).",
        rounds: [
          {
            noOfRounds: 2,
            round1: "Online entry (video entry)",
