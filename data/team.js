...
export const teamData = {
  ...
  competitionHead: [
    ...
    { name: "Advit Mittal", department: "EL", secretary: "PFAC" },
  ],
  informalsHeads: [
    ...
    { name: "Animesh Srivastava", department: "EL", core: true },
  ...
  securityHeads: [
    ...
    { name: "Stuti Mishra", department: "EL" },
    { name: "Pritinjay Kumar Yadav", department: "ME" },
  ],
  creativeHeads: [
    { name: "Deepanshi Srivastava", department: "CE", core: true },
    { name: "Shiv Pratap Singh", department: "EL" },
    { name: "Ansh Barnwal", department: "CSE" },
    { name: "Priya Vishwakarma", department: "IT" },
    { name: "Stuti Mishra", department: "EL" },
    { name: "Ishan Garg", department: "EL" },
    { name: "Avidha Mandal", department: "IT" },
    { name: "Shivam Varshaney", department: "IT" },
