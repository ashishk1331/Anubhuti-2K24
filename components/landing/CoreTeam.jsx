          ...
          <div className="mt-12 flex justify-center">
            <div className="border border-gray-200 p-1.5 ps-5 rounded-full dark:border-gray-700">
              <div className="flex items-center gap-x-3">
                ...
                <a
                  className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-gray-200 bg-white text-blue-600 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-blue-500 dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="#"
                >
                  We are hiring
                  <svg
