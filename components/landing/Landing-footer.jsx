...
export default function (props) {
  return (
    ...
    >
      ...
      <div className="absolute text-xs sm:text-sm z-10 w-full  sm:p-8 p-4 bg-[#101010] -bottom-6 sm:-bottom-10 md:-bottom-7 lg:-bottom-3 flex sm:flex-row flex-col sm:justify-between sm:items-center">
